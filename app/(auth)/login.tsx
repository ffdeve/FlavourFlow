      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        <View className="pt-2">
          ...
          <View className="mb-5 items-center justify-center w-full h-full relative ">
            ...
            {/* Title Overlay */}
            <Text 
              className="absolute text-6xl font-semibold pt-2 text-primary"
              style={{ 
          ...
          <View className='pt-8'>
          {/* Email Button */}
          <TouchableOpacity className="w-auto bg-primary rounded-lg py-3 px-6 mx-8 items-center justify-center mb-3 " onPress={() => router.push('/(auth)/login-email')}>
